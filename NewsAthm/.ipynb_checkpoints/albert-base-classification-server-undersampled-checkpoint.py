# undersampled 欠采样平衡后数据进行训练 ephoch=10  使用albert-base
# update 3.6 FIX版本
# update:3.9 FIX2
...
reset_log('./logs_FIX2/albert-base-classification-server-undersampled_training.log')  ### update
...
# # 加载之前保存的模型参数
# # 2.22 13:25 e10
# model.load_state_dict(torch.load('./models/ALBert/AlBert-base_classification_undersampled_new_epoch_10.pth')) ## !!!!
# # ======================================================================================================================================================
