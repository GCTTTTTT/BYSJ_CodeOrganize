# 平衡前随机采样145140条数据 进行训练 ephoch=10
# update:_randsample122780
# update:3.7 _randsample110502 去除档案类
# update 3.8 FIX3版本 其他只保留意见观点
...
reset_log('./logs_FIX3/bert-classification-server-57879_training.log')
logger = logging.getLogger(__name__)
logging.info('This is a log info')

# # 配置日志记录器
# logging.basicConfig(filename='./logs/bert-classification-server-145140_training.log', level=logging.INFO, format='%(asctime)s - %(message)s', datefmt='%Y-%m-%d %H:%M:%S')
...
# file_path = './datasets/deduplicated_mangoNews_Nums3000p_CategoryMerge_new_randsample145140.csv'          # ./deduplicated_mangoNews_Nums3000p_CategoryMerge_new.csv进行随机抽样出145140条 用于数据平衡前后结果比较（145140条 1.2g) 

# file_path = './datasets_FIX/FIX_deduplicated_mangoNews_Nums3000p_CategoryMerge_new_randsample122780.csv' # new  ### update
# file_path = './datasets_FIX2/FIX2_deduplicated_mangoNews_Nums3000p_CategoryMerge_new_randsample110502.csv' # new  ### update
file_path = './datasets_FIX3/FIX3_deduplicated_mangoNews_Nums3000p_CategoryMerge_new_randsample57879.csv' # new  ### update
...
# # 加载之前保存的模型参数
# # 2.22 0:25 e10
# model.load_state_dict(torch.load('./models/Bert-145150/bert-base-uncased_classification_randsample145140_epoch_15.pth')) ## !!!!
# ======================================================================================================================================================
...
# model_path = f"./models_FIX/{model_name}_classification_randsample145140_epoch_{num_epochs}.pth"  ### update
# model_path = f"./models_FIX2/{model_name}_classification_randsample110502_epoch_{num_epochs}.pth"  ### update
model_path = f"./models_FIX3/{model_name}_classification_randsample110502_epoch_{num_epochs}.pth"  ### update
