...
# reset_log('./logs_FIX/bert-classification-server-undersampled_training.log')  ### update
reset_log('./logs_FIX3/bert-classification-server-undersampled_training.log')  ### update
...
file_path = './datasets_FIX3/FIX3_deduplicated_mangoNews_Nums3000p_CategoryMerge_new_undersampled.csv' # new  ### update
...
# # 加载之前保存的模型参数
# # 2.22 0:25 e10
# model.load_state_dict(torch.load('./models/Bert-undersampled/bert-base-uncased_classification_undersampled_new_epoch_10.pth')) ## !!!!
# # ======================================================================================================================================================
...
# 使用DataLoader加载数据
train_loader = DataLoader(train_dataset, batch_size=64, shuffle=True) # 2.20 32-64 ## 64-128
...
# model_path = f"./models_FIX/{model_name}_classification_undersampled_new_epoch_{num_epochs}.pth"  ##  ### update
# model_path = f"./models_FIX2/{model_name}_classification_undersampled_new_epoch_{num_epochs}.pth"  ##  ### update
model_path = f"./models_FIX3/{model_name}_classification_undersampled_new_epoch_{num_epochs}.pth"  ##  ### update
