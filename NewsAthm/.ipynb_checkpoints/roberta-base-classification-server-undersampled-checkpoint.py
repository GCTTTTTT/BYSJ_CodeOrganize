# undersampled 欠采样平衡后数据进行训练 ephoch=10  使用roberta-base
# update 3.6 FIX版本
# update 3.8 FIX2版本
...
reset_log('./logs_FIX2/roberta-base-classification-server-undersampled_training.log') ### update
...
model = RobertaForSequenceClassification.from_pretrained(Bert_path, num_labels=num_classes)
...
# # 加载之前保存的模型参数
# # 2.22 12:25 e10
# model.load_state_dict(torch.load('./models/Roberta/roberta-base_classification_undersampled_new_epoch_10.pth')) ## !!!!
# ======================================================================================================================================================
