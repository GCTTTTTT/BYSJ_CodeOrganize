...
data = pd.read_csv('./datasets/news_20240302_20240318.csv')  ## 对0302-0311这10天进行评估  从数据库爬取（定时任务）--->拿到数据--->根据date筛选
...
# 结束日期
end_date = start_date + timedelta(days=16)  # 加上9天，因为要遍历10天（包括开始日期）
...
for date in date_list:
    ...
    processed_data_file_name = f"./datasets/mbert/news_{date_UNI}_processed_{model_CLS_name}.csv"
